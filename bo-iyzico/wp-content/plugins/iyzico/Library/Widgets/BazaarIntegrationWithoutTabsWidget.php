...
class BazaarIntegrationWithoutTabsWidget extends \WP_Widget
{
    const WIDGET_NAME = 'BazaarIntegrationWithoutTabsWidget';
    const WIDGET_TITLE = 'Bazaar Integration Without Tabs Widget';
