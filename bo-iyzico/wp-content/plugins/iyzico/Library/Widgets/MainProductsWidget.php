...
// Creating the widget
class MainProductsWidget extends \WP_Widget
{
    const WIDGET_NAME = 'MainProductsWidget';
    const WIDGET_TITLE = 'Main Products Widget';
    ...
    public function getFields(){
        ...
        for($i=1;$i<4;$i++) {
            $layout['product'.$i.'Title'] = array(
                    "type"=>"input",
                    "default"=>"",
                    "label"=> "Ürün ".$i." Başlığı"
            );
            $layout['product'.$i.'IconClass'] = array(
                "type"=>"input",
                "default"=>"",
                "label"=> "Ürün ".$i." İkonu için CSS Classı"
            );
            $layout['product'.$i.'Name'] = array(
                "type"=>"input",
                "default"=>"",
                "label"=> "Ürün ".$i." İsmi"
            );
            $layout['product'.$i.'Description'] = array(
                "type"=>"textarea",
                "default"=>"",
                "label"=> "Ürün ".$i." Açıklama Yazısı"
            );
            $layout['product'.$i.'ButtonText'] = array(
                "type"=>"input",
                "default"=>"",
                "label"=> "Ürün ".$i." Button Yazısı"
            );
            $layout['product'.$i.'ButtonUrl'] = array(
                "type"=>"input",
                "default"=>"",
                "label"=> "Ürün ".$i." Button Linki"
            );
        }
        return $layout;
    }
