...
class InternationalPageHeadWidget extends \WP_Widget
{
    const WIDGET_NAME = 'InternationalPageHeadWidget';
    const WIDGET_TITLE = 'International Page Head Widget';
    ...
    public function getFields(){
        return array(
            ...
            'explanationTitle'  => array(
                "type"      => "input",
                "default"   => "",
                "label"     => "Açıklama alanı başlığı"
            ),
            'explanationLeftColumn' => array(
                "type"      => "textarea",
                "default"   => "",
                "label"     => "Açıklama alanı sol kolon yazısı"
            ),
            'explanationRightColumn' => array(
                "type"      => "textarea",
                "default"   => "",
                "label"     => "Açıklama alanı sağ kolon yazısı"
            )
        );
    }
