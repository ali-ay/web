...
class IntWhyIyzicoWidget extends \WP_Widget
{
    const WIDGET_NAME = 'IntWhyIyzicoWidget';
    const WIDGET_TITLE = 'International Why iyzico Widget';
    ...
    public function getFields(){
        return array(
            ...
            'boxFourIconClass'  => array(
                "type"      => "input",
                "default"   => "",
                "label"     => "Box #4 Icon Class"
            ),
            'boxFourTitle'  => array(
                "type"      => "input",
                "default"   => "",
