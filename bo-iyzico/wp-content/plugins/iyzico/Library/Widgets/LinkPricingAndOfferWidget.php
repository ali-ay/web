...
class LinkPricingAndOfferWidget extends \WP_Widget
{
    const WIDGET_NAME = 'LinkPricingAndOfferWidget';
    const WIDGET_TITLE = 'Link Pricing And Offer Widget';
    ...
    public function getFields(){
        return array(
            ...
            'offerTitle' => array(
                "type"      => "input",
                "default"   => "Bireysel Satıcılar",
                "label"     => "Offer alanı title"
            ),
            'offerSubTitle' => array(
                "type"      => "input",
                "default"   => "(Şirket Sahibi Olmayan)",
                "label"     => "Offer alanı Subtitle"
            ),
            'offerPricingInformation'  => array(
                "type"      => "input",
                "default"   => "%3,99 + 0,25 TL",
                "label"     => "Offer alanı Price Bilgisi"
            ),
            'offerDescription' => array(
                "type"      => "input",
                "default"   => "Başarılı işlem başına komisyon<br>Kurulum ücreti yok! Sabit ücret yok!",
            ...
            'campaignText' => array(
                "type"      => "input",
                "default"   => "Kapanya",
                "label"     => "If there is text in this field, it will show a red badge with this text"
            ),
        );
    }
