...
class businessPwiSssWidget extends \WP_Widget
{
    const WIDGET_NAME = 'businessPwiSssWidget';
    const WIDGET_TITLE = 'Business Pwi Sss Widget';
    ...
    public function getFields(){
        return array(
            ...
            'desc' => array(
                "type" => "input",
                "default" => "iyzico ile öde hakkında sıkça sorulan soruları inceleyin ve daha fazlasını öğrenin.",
