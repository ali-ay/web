...
class BuyerProtectionReferencesWidget extends \WP_Widget
{
    const WIDGET_NAME = 'BuyerProtectionReferencesWidget';
    const WIDGET_TITLE = 'Buyer Protection References Widget';
