...
class PosIntegrationWithoutTabsWidget extends \WP_Widget
{
    const WIDGET_NAME = 'PosIntegrationWithoutTabsWidget';
    const WIDGET_TITLE = 'Pos Integration Without Tabs Widget';
