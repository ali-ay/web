...
class personalHomeMobileAppSliderWidget extends \WP_Widget
{
    const WIDGET_NAME = 'personalHomeMobileAppSliderWidget';
    const WIDGET_TITLE = 'Personal Home Mobile App Slider Widget';
    ...
    public function widget($args, $instance)
    {
        ...
        if ($post) {
            ...
            $jsonData['features'] = json_decode($stringResponse);
        }
