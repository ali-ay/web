...
class personalHomeFeatureListWidget extends \WP_Widget
{
    const WIDGET_NAME = 'personalHomeFeatureListWidget';
    const WIDGET_TITLE = 'Personal Home Feature List Widget';
