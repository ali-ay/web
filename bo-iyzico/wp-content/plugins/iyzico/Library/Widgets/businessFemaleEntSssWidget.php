...
class businessFemaleEntSssWidget extends \WP_Widget
{
    const WIDGET_NAME = 'businessFemaleEntSssWidget';
    const WIDGET_TITLE = 'Business Female Entrepreneur Sss Widget';
    ...
    public function getFields(){
        return array(
            ...
            'desc' => array(
                "type" => "input",
                "default" => "iyzico Kadın Girişimci Destek Programı hakkında sıkça sorulan soruları inceleyin ve daha fazlasını öğrenin.",
                "label" => "Sık Sorulan Sorular Alanı Açıklaması"
            ),
