...
class mainHeaderWidget extends \WP_Widget
{
    const WIDGET_NAME = 'mainHeaderWidget';
    const WIDGET_TITLE = 'Main Header Widget';
    ...
    public function getFields(){
        return array(
            ...
            'firstButtonClass' => array(
                "type"      => "input",
                "default"   => "",
                "label"     => "First Button Class"
            ),
            'firstCallToActionTitle'  => array(
                "type"      => "input",
                "default"   => "",
                "label"     => "First Button Text"
            ),
            'firstCallToActionUrl'  => array(
                "type"      => "input",
                "default"   => "",
                "label"     => "First Button Url"
            ),
            'secondButtonClass' => array(
                "type"      => "input",
                "default"   => "",
                "label"     => "Second Button Class"
            ),
            'secondCallToActionTitle'  => array(
                "type"      => "input",
                "default"   => "",
                "label"     => "Second Button Text"
            ),
            'secondCallToActionUrl'  => array(
                "type"      => "input",
                "default"   => "",
