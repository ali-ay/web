...
// Creating the widget
class CallMeWidget extends \WP_Widget
{

    function __construct()
    {
        parent::__construct(
            'CallMeWidget', __('Sub Page Call Me Widget', 'iyzico'), array('description' => __('Call Me Form At The Bottom of Call Me Pages', 'iyzico'))
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        foreach($fields as $fieldName=>$fieldObject) {
            ...
            if (function_exists ( 'icl_translate' )){
                $fields[$fieldName]['value']    = icl_translate('Widgets', 'Call Me Widget -'.$fieldName, $instance[$fieldName]);
            }
        }
                ...
                <form id="call-me-form" validate="validate">
                    <div class="row">
                        <div class="col-lg-4 col-sm-4">
                            <input class="name-input" type="text" autocomplete="off" name="name" required placeholder="<?php echo($fields['nameSurnamePlaceholder']['value']) ?>"/>
                        </div>
                        <div class="col-lg-4 col-sm-4">
    ...
    public function update($new_instance, $old_instance)
    {
        ...
        foreach(self::getFields() as $fieldName=>$fieldOptions) {
            ...
            if (function_exists ( 'icl_register_string' )){
                icl_register_string('Widgets', 'Call Me Widget -'.$fieldName, $instance[$fieldName]);
            }
        }
        return $instance;
    }
