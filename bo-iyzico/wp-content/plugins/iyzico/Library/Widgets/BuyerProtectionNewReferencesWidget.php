...
class BuyerProtectionNewReferencesWidget extends \WP_Widget
{
    const WIDGET_NAME = 'BuyerProtectionNewReferencesWidget';
    const WIDGET_TITLE = 'Buyer Protection New References Widget';
    ...
    public function getFields(){
        return array(
            'title'  => array(
                "type"      => "input",
                "default"   => "iyzico Korumalı Alışverişli E-Ticaret Siteleri",
                "label"     => "Başlık"
            ),
            'subTitle'  => array(
                "type"      => "textarea",
                "default"   => "Çiçek, giyim, spor, annebebek, mobilya, spor, supermarket ve bir çok kategori de sitede tüm ihtiyaçlarınızı güvenle  satın alabilirsiniz.",
                "label"     => "Kısa Açıklama Yazısı"
            ),
            'references' => array(
                "type"      => "input",
                "default"   => "",
                "label"     => "Referanslar İçin Kullanılacak Kategori Slug'ı"
            ),
            'number'  => array(
                "type"      => "input",
                "default"   => "+16.000",
                "label"     => "Korumalı Alışveriş Kullanan Site Sayısı"
            ),
            'buttononUrl'  => array(
                "type"      => "input",
                "default"   => "",
    ...
    public function widget($args, $instance)
    {
        ...
        foreach ($posts_array as $key=>$post){
            array_push($jsonData['references'],array(
