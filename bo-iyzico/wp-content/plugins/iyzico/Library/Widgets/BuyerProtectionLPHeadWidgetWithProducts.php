...
class BuyerProtectionLPHeadWidgetWithVideo extends \WP_Widget
{
    const WIDGET_NAME = 'BuyerProtectionLPHeadWidgetWithVideo';
    const WIDGET_TITLE = 'Buyer Protection Widget With Video';
    ...
    public function getFields(){
        return array(
            'title'  => array(
                "type"      => "input",
                "default"   => "Korumalı Alışveriş",
                "label"     => "Başlık"
            ),
            'subTitle'  => array(
                "type"      => "textarea",
                "default"   => "İnternetten Alışverişlerinizde Ödemeden Teslimata Yanınızdayız",
                "label"     => "Kısa Açıklama Yazısı"
            ),
            'buyerProtectionButton' => array(
                "type"      => "input",
                "default"   => "iyzico Korumalı Alışveriş Sitelerine Git",
                "label"     => "Header Buton Yazısı"
            ),
            'buyerProtectionButtonUrl' => array(
                "type"      => "input",
                "default"   => "",
