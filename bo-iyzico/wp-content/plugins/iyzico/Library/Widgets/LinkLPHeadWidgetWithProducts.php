...
class LinkLPHeadWidgetWithVideo extends \WP_Widget
{
    const WIDGET_NAME = 'LinkLPHeadWidgetWithVideo';
    const WIDGET_TITLE = 'Link Head Widget With Video';
    ...
    public function getFields(){
        return array(
            ...
            'callToActionTitle'  => array(
                "type"      => "input",
                "default"   => "Şimdi Üye Ol",
                "label"     => "Başlık"
            ),
            'howToUseTitle'  => array(
                "type"      => "input",
                "default"   => "Nasıl iyziLink Oluşturabilirim?",
                "label"     => "Nasıl Kullanırım Butonu yazısı"
            ),
            'referencesCategoryId' => array(
                "type"      => "input",
                "default"   => "5",
                "label"     => "Referanslar İçin Kullanılacak Kategori ID"
            ),
            'videoMp4' => array(
                "type"      => "image",
                "default"   => "",
    ...
    public function widget($args, $instance)
    {
        ...
        $args = array(
            'posts_per_page'   => 8,
            'offset'           => 0,
            'category'         => $fields['referencesCategoryId']['value'],
            'category_name'    => '',
            'orderby'          => 'meta_value',
            'order'            => 'ASC',
            'include'          => '',
