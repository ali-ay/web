...
class LinkTestimonialsWidget extends \WP_Widget
{
    const WIDGET_NAME = 'LinkTestimonialsWidget';
    const WIDGET_TITLE = 'iyzilink Testimonials Widget';
    ...
    public function getFields(){
        return array(
            'title' => array(
                "type" => "input",
                "default" => "Referanslar",
                "label" => "Testimonials Alanı başlığıß"
            ),
    ...
    public function widget($args, $instance)
    {
        ...
        foreach ($posts_array as $key=>$post){
            ...
            $testimonialObject = array(
                    ...
                    'subtext'=>$logoAndContentObject->subtext,
