...
class EuropeIntegrationWithoutTabsWidget extends \WP_Widget
{
    const WIDGET_NAME = 'EuropeIntegrationWithoutTabsWidget';
    const WIDGET_TITLE = 'Europe Integration Without Tabs Widget';
