...
class EuropeReferenceLogosWidget extends \WP_Widget
{
    const WIDGET_NAME = 'EuropeReferenceLogosWidget';
    const WIDGET_TITLE = 'Europe Reference Logos Widget';
    ...
    public function getFields(){
        return array(
            ...
            'referenceLogosCategorySlug'  => array(
                "type"      => "input",
                "default"   => "",
    ...
    public function widget($args, $instance)
    {
        ...
        $args = array(
            'posts_per_page'   => 8,
            'offset'           => 0,
            'category_name'    => $fields['referenceLogosCategorySlug']['value'],
            'orderby'          => 'meta_value',
            'order'            => 'ASC',
