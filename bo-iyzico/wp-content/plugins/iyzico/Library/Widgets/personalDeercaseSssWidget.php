...
class personalDeercaseSssWidget extends \WP_Widget
{
    const WIDGET_NAME = 'personalDeercaseSssWidget';
    const WIDGET_TITLE = 'Personal Deercase Sss Widget';
    ...
    public function getFields(){
        return array(
            ...
            'desc' => array(
                "type" => "input",
                "default" => "iyzico Mobil Uygulaması hakkında sıkça sorulan soruları inceleyin ve daha fazlasını öğrenin.",
