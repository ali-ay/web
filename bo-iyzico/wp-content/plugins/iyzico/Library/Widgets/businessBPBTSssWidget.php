...
class businessBPBTSssWidget extends \WP_Widget
{
    const WIDGET_NAME = 'businessBPBTSssWidget';
    const WIDGET_TITLE = 'Business BP Bank Transfer Sss Widget';
    ...
    public function getFields(){
        return array(
            ...
            'desc' => array(
                "type" => "input",
                "default" => "Çoklu Para Gönderimi hakkında sıkça sorulan soruları inceleyin ve daha fazlasını öğrenin.",
