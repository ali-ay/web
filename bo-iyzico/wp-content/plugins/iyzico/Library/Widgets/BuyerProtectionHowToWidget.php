...
class BuyerProtectionHowToWidget extends \WP_Widget
{
    const WIDGET_NAME = 'BuyerProtectionHowToWidget';
    const WIDGET_TITLE = 'Buyer Protection How To Widget';
    ...
    public function getFields(){
        return array(
            'title'  => array(
                "type"      => "input",
                "default"   => "iyzico Korumalı Alışveriş’i Nasıl Kullanırım?",
                "label"     => "Başlık"
            ),
            'description'  => array(
                "type"      => "textarea",
                "default"   => "%100 memnuniyet garantili alışveriş devri başlıyor!<br>Anlaşmalı olduğumuz e-ticaret sitelerinden çekinmeden alışveriş yapabilirsiniz. ",
                "label"     => "Kısa Açıklama Yazısı"
            ),
            'image' => array(
                "type"      => "image",
                "default"   => "",
                "label"     => "Nasıl Kullanırım Gif Alanı"
            ),
            'sectionOneNumber'  => array(
                "type"      => "input",
                "default"   => "1",
                "label"     => "Section Number"
            ),
            'sectionOneText'  => array(
                "type"      => "input",
                "default"   => "iyzico Korumalı Alışveriş bilgilendirme kutusunu gördüğünüz sitede ürünlerinizi seçin.",
                "label"     => "Section One Content"
            ),
            'sectionTwoNumber'  => array(
                "type"      => "input",
                "default"   => "2",
                "label"     => "Section Two Number"
            ),
            'sectionTwoText'  => array(
                "type"      => "input",
                "default"   => "Ödeme sayfasında 'iyzico Korumalı Alışveriş' seçeneğini işaretleyin ve ödemenizi tamamlayın.",
                "label"     => "Section Two Content"
            ),
            'sectionThreeNumber'  => array(
                "type"      => "input",
                "default"   => "3",
                "label"     => "Section Three Number"
            ),
            'sectionThreeText'  => array(
                "type"      => "input",
                "default"   => "Size gönderdiğimiz SMS veya e-mail'de bulunan linkten kargo takibinizi yapın, ihtiyacınız anında 7/24 canlı destek alın.",
    ...
    public function widget($args, $instance)
    {
        ...
        $args = array(
            'posts_per_page'   => 8,
            'offset'           => 0,
            'category_name'    => $fields['references']['value'],
            'orderby'          => 'meta_value',
            'order'            => 'ASC',
            'include'          => '',
            'exclude'          => '',
