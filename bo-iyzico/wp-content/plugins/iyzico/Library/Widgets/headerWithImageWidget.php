...
// Creating the widget
class headerWithImageWidget extends \WP_Widget
{

    const WIDGET_NAME = 'headerWithImageWidget';
    const WIDGET_TITLE = 'Header With Image';
    ...
    public function getFields(){
        return array(
            ...
            'image'  => array(
                "type"      => "image",
                "default"   => "",
                "label"     => "Header Image (1242x1352 png)"
            ),
            'headerImageAlt' => array(
                "type"      => "input",
                "default"   => "",
