...
class personalBPSssWidget extends \WP_Widget
{
    const WIDGET_NAME = 'personalBPSssWidget';
    const WIDGET_TITLE = 'Personal Buyer Protection Sss Widget';
    ...
    public function getFields(){
        return array(
            ...
            'desc' => array(
                "type" => "input",
                "default" => "iyzico Korumalı Alışveriş hakkında sıkça sorulan soruları inceleyin ve daha fazlasını öğrenin.",
