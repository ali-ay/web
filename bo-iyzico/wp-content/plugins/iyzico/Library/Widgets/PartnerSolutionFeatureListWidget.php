...
class PartnerSolutionFeatureListWidget extends \WP_Widget
{
    const WIDGET_NAME = 'PartnerSolutionFeatureListWidget';
    const WIDGET_TITLE = 'Partner Solution Feature List Widget';
