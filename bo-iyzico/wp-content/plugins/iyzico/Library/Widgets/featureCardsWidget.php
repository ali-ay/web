...
// Creating the widget
class featureCardsWidget extends \WP_Widget
{

    const WIDGET_NAME = 'featureCardsWidget';
    const WIDGET_TITLE = 'Feature Crads';
    ...
    public function getFields(){
        return array(
            'sectionOneTitle'  => array(
                "type"      => "input",
                "default"   => "",
                "label"     => "Section One Title"
            ),
            'sectionOneDescription'  => array(
                "type"      => "textarea",
                "default"   => "",
                "label"     => "Section One Description"
            ),
            'sectionTwoTitle'  => array(
                "type"      => "input",
                "default"   => "",
                "label"     => "Section Two Title"
            ),
            'sectionTwoDescription'  => array(
                "type"      => "textarea",
                "default"   => "",
                "label"     => "Section Two Description"
            ),
            'sectionThreeTitle'  => array(
                "type"      => "input",
                "default"   => "",
                "label"     => "Section Three Title"
            ),
            'sectionThreeDescription'  => array(
                "type"      => "textarea",
                "default"   => "",
