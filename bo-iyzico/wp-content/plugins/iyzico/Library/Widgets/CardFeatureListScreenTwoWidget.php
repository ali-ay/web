...
class CardFeatureListScreenTwoWidget extends \WP_Widget
{
    const WIDGET_NAME = 'CardFeatureListScreenTwoWidget';
    const WIDGET_TITLE = 'Card Feature List Screen Two Widget';
