...
class BuyerProtectionFeatureListWidget extends \WP_Widget
{
    const WIDGET_NAME = 'BuyerProtectionFeatureListWidget';
    const WIDGET_TITLE = 'Buyer Protection Feature List Widget';
